 ...
 *   type: string
 *   required: true
 *   description: 'npm project to check: a git URL (https://, ssh://, git@host:owner/name) or a path to a local checkout with an npm, pnpm, yarn, uv, poetry, pip, Cargo or Go module file'
